...
export const GalleryApp: React.FC<GalleryAppProps> = ({ 
  ...
  // FIXED: New data check useEffect to handle loading completion
  useEffect(() => {
    ...
    const checkDataLoaded = () => {
      const hasProfile = profileDataLoaded || galleryProfileData !== null; // More flexible check
      const hasMediaData = mediaItems !== undefined;
      const hasSiteStatus = siteStatus !== null;
      const hasUserName = userName !== null && userName !== '';
      ...
      console.log('📊 Data loading status:', {
        ...
        hasUserName,
        profileDataLoaded,
        galleryProfileDataExists: !!galleryProfileData
      });

      if (hasProfile && hasMediaData && hasSiteStatus && hasUserName) {
  ...
  }, [userName, gallery.id, profileDataLoaded, galleryProfileData, mediaItems, siteStatus]);
