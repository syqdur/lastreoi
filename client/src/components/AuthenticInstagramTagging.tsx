...
interface AuthenticInstagramTaggingProps {
  isOpen: boolean;
  onClose: () => void;
...
const AuthenticInstagramTagging: React.FC<AuthenticInstagramTaggingProps> = ({
  isOpen,
  onClose,
  onConfirm,
  mediaUrl,
...
export default AuthenticInstagramTagging;